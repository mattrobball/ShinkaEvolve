...
-- Define the ideal of a point configuration using a line arrangement polynomial.
-- We target the Star Configuration of 3 lines (s=3), which is known to have
-- a resurgence of (s-1)/(s-2) = 2/1 = 2.
-- This is higher than the s=4 case (rho=1.5) or Hessian arrangements.
-- The polynomial F defines the union of 3 lines: x=0, y=0, z=0.
F = x*y*z

-- The singular locus of this arrangement consists of the pairwise intersection points.
-- For F = xyz, the singular locus is given by the Jacobian ideal.
-- J = (yz, xz, xy)
-- The points are (1:0:0), (0:1:0), (0:0:1).
